  ...
  <div class="email-templates-page">
    <div class="header">
      ...
      <div class="actions">
        ...
        <NuxtLink to="/lead-magnet/email-templates/new" class="btn-primary">
          + Nouveau template
        </NuxtLink>
      </div>
    </div>
    ...
    <div v-else-if="templates?.data && templates.data.length > 0" class="templates-grid">
      <div
      ...
      >
        ...
        <div class="template-info">
          <div class="info-row">
            ...
            <span class="value">{{ template.subject }}</span>
          </div>
        ...
        <div class="card-footer">
          ...
          <div class="actions">
            <NuxtLink :to="`/lead-magnet/email-templates/${template.id}`" class="btn-view">
              Voir
            </NuxtLink>
            <button @click="handleDelete(template.id)" class="btn-delete">
              🗑️
            </button>
          </div>
        </div>
    ...
    <div v-else class="empty-state">
      <p>Aucun template d'email créé.</p>
      <NuxtLink to="/lead-magnet/email-templates/new" class="btn-primary">
...
const { templates, loading, error, refresh, deleteTemplate } = useEmailTemplates();

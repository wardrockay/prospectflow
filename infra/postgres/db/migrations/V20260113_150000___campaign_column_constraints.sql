...
COMMENT ON COLUMN public.outreach_campaigns.name IS 'Campaign name, max 100 characters';
COMMENT ON COLUMN public.outreach_campaigns.value_prop IS 'Value proposition, max 150 characters, required';
